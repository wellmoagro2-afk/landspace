...
export default function SensoriamentoRemotoFundamentosAnaliseCientificaPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                Sensoriamento Remoto: Fundamentos para Análise Científica
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Fundamentos físicos e conceituais do sensoriamento remoto aplicados à análise ambiental e territorial.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Quem precisa de base conceitual sólida para análises ambientais",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0 drop-shadow-[0_0_8px_rgba(6,182,212,0.5)] group-hover:text-cyan-300 transition-colors" />
                      <span className="text-base text-slate-300 leading-relaxed group-hover:text-white transition-colors">{item}</span>
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos Físicos do Sensoriamento Remoto",
                      content: "Conceitos básicos, interação radiação-matéria e princípios físicos.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2 – Resoluções Espacial, Espectral e Temporal",
                      content: "Compreensão das resoluções e suas implicações práticas.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – Limites e Potencial das Imagens de Satélite",
                      content: "Capacidades e limitações dos sensores orbitais.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Base Conceitual para Análises Ambientais",
                      content: "Aplicação dos fundamentos em estudos ambientais e territoriais.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("sensoriamento-remoto-fundamentos-analise-cientifica", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/sensoriamento-remoto-fundamentos-analise-cientifica.png"
                        alt="Sensoriamento Remoto: Fundamentos para Análise Científica"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=sensoriamento-remoto-fundamentos-analise-cientifica"
