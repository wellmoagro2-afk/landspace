...
export default function EstudoFragilidadeAmbientalPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                Estudo da Fragilidade Ambiental
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Mapeie a fragilidade dos ambientes e identifique áreas mais sensíveis à intervenção humana por meio do cruzamento automatizado de solo, relevo e clima, com aplicação direta em planejamento e licenciamento ambiental.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Avaliar a fragilidade ambiental de forma integrada",
                    "Cruzar variáveis físicas e ambientais de maneira automatizada",
                    "Gerar classes de fragilidade ambiental consistentes",
                    "Produzir mapas técnicos para zoneamento e licenciamento",
                    "Interpretar resultados para tomada de decisão territorial",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Profissionais envolvidos com licenciamento e zoneamento",
                    "Quem precisa avaliar vulnerabilidade ambiental com base técnica",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos da Fragilidade Ambiental",
                      content: "Conceitos, abordagens clássicas e aplicações da fragilidade ambiental.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2 – Variáveis Ambientais de Entrada",
                      content: "Solo, relevo e clima: preparação e padronização dos dados.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – Cruzamento e Modelagem da Fragilidade",
                      content: "Integração das variáveis e definição das classes de fragilidade.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Geração dos Mapas de Fragilidade",
                      content: "Automatização do processo e validação dos resultados.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5 – Aplicações Práticas e Interpretação",
                      content: "Uso dos mapas em planejamento, licenciamento e estudos ambientais.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300 transition-shadow">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/estudo-fragilidade-ambiental.png"
                        alt="Estudo da Fragilidade Ambiental"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=estudo-fragilidade-ambiental"
