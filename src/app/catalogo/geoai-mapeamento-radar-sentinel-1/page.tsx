...
export default function GeoaiMapeamentoRadarSentinel1Page() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                GeoAI: Mapeamento com Radar (Sentinel-1)
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Mapeie uso e cobertura da terra em qualquer condição climática utilizando imagens Radar Sentinel-1 e Machine Learning em um workflow automatizado.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {["Acesso à Ferramenta Sentinel-1 GeoAI SAR Pipeline","Pré-processamento automático de imagens SAR","Classificação com Machine Learning em dados radar","Mapas técnicos independentes de nuvens",""].map((item, idx) => (
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("geoai-mapeamento-radar-sentinel-1", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/geoai-mapeamento-radar-sentinel-1.png"
                        alt="GeoAI: Mapeamento com Radar (Sentinel-1)"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=geoai-mapeamento-radar-sentinel-1"
