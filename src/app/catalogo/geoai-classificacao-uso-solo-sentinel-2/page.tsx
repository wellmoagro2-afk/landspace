...
export default function GeoAIClassificacaoUsoSoloSentinel2Page() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                GeoAI: Classificação de Uso e Cobertura da Terra com Sentinel-2
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Domine a classificação de uso e cobertura da terra com imagens Sentinel-2 e algoritmos de Machine Learning. Execute um pipeline automatizado baseado em Random Forest e gere mapas confiáveis para análise ambiental, agrícola e territorial.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Processar imagens Sentinel-2 de forma automatizada",
                    "Selecionar e preparar bandas espectrais e índices",
                    "Treinar e validar modelos de classificação com Random Forest",
                    "Gerar mapas de uso e cobertura da terra em alta resolução (10 m)",
                    "Avaliar a qualidade e consistência dos resultados",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    "Estudantes e pesquisadores em Geotecnologias e Ciências Ambientais",
                    "Analistas de sensoriamento remoto e geoprocessamento",
                    "Profissionais que trabalham com uso e cobertura da terra",
                    "Consultores ambientais e agrícolas",
                    "Quem deseja aplicar GeoAI de forma prática e reprodutível",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos de GeoAI e Sentinel-2",
                      content: "Conceitos de Machine Learning aplicados ao sensoriamento remoto óptico.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2 – Aquisição e Preparação das Imagens",
                      content: "Download, correções, composição de bandas e índices espectrais.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – Treinamento do Modelo Random Forest",
                      content: "Amostragem, treinamento e validação do classificador.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Classificação Automatizada",
                      content: "Execução do pipeline GeoAI e geração dos mapas finais.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5 – Avaliação, Pós-processamento e Aplicações",
                      content: "Análise de acurácia, ajustes finais e aplicações práticas.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("geoai-classificacao-uso-solo-sentinel-2", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300 transition-shadow">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/geoai-classificacao-uso-solo-sentinel-2.png"
                        alt="GeoAI: Classificação de Uso e Cobertura da Terra com Sentinel-2"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=geoai-classificacao-uso-solo-sentinel-2"
