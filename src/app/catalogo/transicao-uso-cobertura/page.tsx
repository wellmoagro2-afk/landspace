          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Não perca dias cruzando mapas manualmente. Domine a análise temporal de paisagens e gere mapas, matrizes de transição, gráficos de persistência, ganhos, perdas, mudanças e indicadores espaciais confiáveis em minutos, com precisão científica.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Analisar mudanças de uso e cobertura da terra",
                    "Cruzar mapas multitemporais sem erros",
                    "Gerar matrizes de transição prontas para Excel e Word",
                    "Calcular ganhos, perdas, persistências e mudanças",
                    "Criar mapas e gráficos profissionais para artigos, relatórios e perícias",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Quem precisa de resultados técnicos rápidos e confiáveis",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0 drop-shadow-[0_0_8px_rgba(6,182,212,0.5)] group-hover:text-cyan-300 transition-colors" />
                      <span className="text-base text-slate-300 leading-relaxed group-hover:text-white transition-colors">{item}</span>
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1: Onboarding e Fundamentos",
                      content: "Boas-vindas, visão geral da metodologia e conceitos essenciais de Uso e Cobertura da Terra.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2: O Toolkit (Download e Instalação)",
                    ...
                    {
                      title: "Módulo 3: Workflow de Processamento (Tutorial)",
                      content: "Executando a rotina na prática. Importação de dados do MapBiomas e processamento automatizado.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4: Inteligência de Dados (Análise)",
                      content: "Interpretando a Matriz de Transição, analisando métricas de ganho/perda e gerando gráficos de alto impacto.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
