...
export default function MorfometriaBaciasHidrograficasPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Domine a análise morfométrica de bacias hidrográficas por meio da delimitação automatizada, extração de rede de drenagem e cálculo de parâmetros hidrológicos essenciais, gerando mapas e relatórios técnicos com padrão reprodutível.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Delimitar bacias e sub-bacias com base em modelos digitais de elevação",
                    "Extrair e hierarquizar a rede de drenagem automaticamente",
                    "Calcular parâmetros morfométricos clássicos e aplicados",
                    "Gerar mapas e relatórios técnicos para estudos hidrológicos",
                    "Interpretar métricas para diagnóstico e planejamento de bacias",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    "Estudantes e pesquisadores em Hidrologia, Geografia e Ciências Ambientais",
                    "Analistas ambientais e hidrológicos",
                    "Profissionais de recursos hídricos e planejamento territorial",
                    "Consultores ambientais e agrícolas",
                    "Quem trabalha com bacias hidrográficas, drenagem e DEMs",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0 drop-shadow-[0_0_8px_rgba(6,182,212,0.5)] group-hover:text-cyan-300 transition-colors" />
                      <span className="text-base text-slate-300 leading-relaxed group-hover:text-white transition-colors">{item}</span>
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos de Bacias e Morfometria",
                      content: "Conceitos, parâmetros clássicos e aplicações em estudos hidrológicos.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2 – Preparação do DEM e Condicionamento Hidrológico",
                      content: "Preenchimento de depressões, direção e acumulação de fluxo.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – Delimitação de Bacias e Sub-bacias",
                      content: "Pontos de exutório, delimitação automática e validação.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Rede de Drenagem e Hierarquização",
                      content: "Extração, ordenamento (Strahler) e métricas da drenagem.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5 – Parâmetros Morfométricos e Relatórios",
                      content: "Cálculo automatizado, mapas finais e interpretação técnica.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("morfometria-bacias-hidrograficas", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/morfometria-bacias-hidrograficas.png"
                        alt="Morfometria de Bacias Hidrográficas"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=morfometria-bacias-hidrograficas"
