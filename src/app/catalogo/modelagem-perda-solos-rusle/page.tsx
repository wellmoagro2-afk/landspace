...
export default function ModelagemPerdaSolosRuslePage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                Modelagem de Perda de Solos com a{" "}
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Domine a equação RUSLE (Revised Universal Soil Loss Equation) e aprenda a modelar a erosão do solo 
                com precisão. Gere mapas de perda de solos profissionais para projetos ambientais, agrícolas e de conservação.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Metodologia completa da equação RUSLE e seus fatores (R, K, LS, C, P).",
                    "Preparação e processamento de dados para modelagem de erosão.",
                    "Geração de mapas de perda de solos em toneladas por hectare/ano.",
                    "Análise espacial de áreas críticas de erosão.",
                    "Interpretação de resultados para projetos de conservação e planejamento.",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <CheckCircle2 className="w-5 h-5 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.5)] mt-1 flex-shrink-0 group-hover:text-emerald-600 transition-colors" />
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    "Engenheiros agrônomos e ambientais que trabalham com conservação do solo.",
                    "Geógrafos e analistas de geoprocessamento em projetos de erosão.",
                    "Pesquisadores que precisam modelar perda de solos para estudos científicos.",
                    "Consultores ambientais em projetos de licenciamento e recuperação de áreas.",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <CheckCircle2 className="w-5 h-5 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.5)] mt-1 flex-shrink-0 group-hover:text-sky-600 transition-colors" />
                      <span className="text-base text-slate-300 leading-relaxed group-hover:text-white transition-colors">{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1: Fundamentos da RUSLE",
                      content: "Entenda os conceitos teóricos da equação RUSLE e seus cinco fatores: fator de erosividade da chuva (R), fator de erodibilidade do solo (K), fator topográfico (LS), fator de cobertura e manejo (C) e fator de práticas conservacionistas (P). Aprenda quando e como aplicar a RUSLE em diferentes contextos.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2: Preparação de Dados",
                      content: "Domine a organização e preparação dos dados necessários para a modelagem: mapas de declividade, mapas de uso e cobertura da terra, dados de precipitação e informações sobre o solo. Aprenda a trabalhar com diferentes fontes de dados e formatos.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3: Cálculo dos Fatores RUSLE",
                      content: "Execute o cálculo de cada fator da RUSLE passo a passo. Aprenda a calcular o fator R a partir de dados pluviométricos, o fator K a partir de características do solo, o fator LS a partir de declividade e comprimento de rampa, e os fatores C e P a partir de uso e manejo.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4: Modelagem e Mapeamento",
                      content: "Execute a modelagem completa da perda de solos combinando todos os fatores. Gere mapas temáticos profissionais de perda de solos em toneladas por hectare/ano. Aprenda a classificar áreas por nível de risco de erosão e criar legendas adequadas.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5: Análise e Interpretação",
                      content: "Interprete os resultados da modelagem e aprenda a identificar áreas críticas de erosão. Crie análises quantitativas, gráficos e relatórios técnicos para apresentação dos resultados em projetos ambientais e de conservação.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    ...
                    <details
                      key={idx}
                      open={modulo.open}
                      className="bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-xl p-6 group hover:border-cyan-500/50 transition-all duration-300 transition-colors"
                    >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 flex-wrap">
                            ...
                            <span className="text-sm text-slate-500 font-normal">
                              ({modulo.aulas} {modulo.aulas === 1 ? "aula" : "aulas"} • {modulo.duracao})
                            </span>
                          </div>
                        </div>
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("modelagem-perda-solos-rusle", COURSES).map((testimonial, idx) => (
                    <div key={idx} className="bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:border-cyan-500/50 transition-all duration-300 transition-colors">
                      ...
                      <div className="flex items-center gap-4">
                        <img
                          ...
                          className="w-12 h-12 rounded-full object-cover border-2 border-white/20 shadow-sm mr-4"
                        />
                        <div>
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300 transition-shadow">
                {/* Imagem da ferramenta */}
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/modelagem-perda-solos-rusle.png"
                        alt="Modelagem de Perda de Solos com a RUSLE"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=modelagem-perda-solos-rusle"
                  ...
                  <div className="text-center pt-4 border-t border-white/10">
                    <Award className="w-8 h-8 text-cyan-400 drop-shadow-[0_0_10px_rgba(6,182,212,0.6)] mx-auto mb-2.5" />
