...
export default function AnaliseVulnerabilidadeRiscosAmbientaisPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                Análise de Vulnerabilidade e Riscos Ambientais
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Avalie vulnerabilidades e riscos ambientais em áreas naturais e antropizadas por meio do cruzamento automatizado de variáveis físicas, ambientais e antrópicas, com aplicação direta em planejamento, licenciamento e perícias.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Avaliar vulnerabilidade ambiental de forma integrada",
                    "Identificar áreas de risco ambiental e territorial",
                    "Integrar fatores naturais e pressão antrópica",
                    "Gerar índices e mapas técnicos de risco",
                    "Interpretar resultados para suporte à decisão",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Profissionais que atuam com licenciamento e perícia ambiental",
                    "Quem precisa avaliar riscos ambientais com base técnica",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos de Vulnerabilidade e Risco",
                      content: "Conceitos, abordagens e aplicações da análise de vulnerabilidade e risco ambiental.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2 – Variáveis Naturais e Antrópicas",
                      content: "Seleção, preparação e padronização dos dados de entrada.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – Modelagem da Vulnerabilidade Ambiental",
                      content: "Integração das variáveis e construção dos índices de vulnerabilidade.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Análise de Riscos Ambientais",
                      content: "Identificação, classificação e espacialização dos riscos.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5 – Aplicações Práticas e Estudos de Caso",
                      content: "Uso dos mapas e índices em planejamento, licenciamento e perícia.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("analise-vulnerabilidade-riscos-ambientais", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300 transition-shadow">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/analise-vulnerabilidade-riscos-ambientais.png"
                        alt="Análise de Vulnerabilidade e Riscos Ambientais"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=analise-vulnerabilidade-riscos-ambientais"
