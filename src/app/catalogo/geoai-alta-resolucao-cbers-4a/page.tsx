...
export default function GeoAIAltaResolucaoCBERS4APage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                GeoAI: Alta Resolução com CBERS-4A
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Explore o potencial das imagens CBERS-4A para mapeamentos detalhados de uso e cobertura da terra. Execute um pipeline automatizado de Machine Learning com Random Forest e gere mapas em alta resolução para aplicações ambientais, urbanas e agrícolas.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Processar imagens CBERS-4A de alta resolução",
                    "Preparar bandas e produtos WPM para classificação",
                    "Aplicar Random Forest em dados ópticos de alta resolução",
                    "Gerar mapas detalhados de uso e cobertura da terra",
                    "Avaliar a qualidade e a consistência dos resultados",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    "Estudantes e pesquisadores em Geotecnologias e Sensoriamento Remoto",
                    "Analistas de geoprocessamento e imagens orbitais",
                    "Profissionais que demandam mapeamentos detalhados",
                    "Consultores ambientais, urbanos e agrícolas",
                    "Quem deseja aplicar GeoAI com dados de alta resolução",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
                      <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0 drop-shadow-[0_0_8px_rgba(6,182,212,0.5)] group-hover:text-cyan-300 transition-colors" />
                      <span className="text-base text-slate-300 leading-relaxed group-hover:text-white transition-colors">{item}</span>
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos do CBERS-4A",
                      content: "Características do sensor, produtos disponíveis e aplicações.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      ...
                      content: "Download, organização e pré-processamento dos dados.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – Preparação para Classificação",
                      content: "Seleção de bandas, índices e amostras de treinamento.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Classificação GeoAI Automatizada",
                      content: "Execução do pipeline com Random Forest e geração dos mapas.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5 – Avaliação e Aplicações Práticas",
                      content: "Validação, pós-processamento e uso dos resultados.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("geoai-alta-resolucao-cbers-4a", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/geoai-alta-resolucao-cbers-4a.png"
                        alt="GeoAI: Alta Resolução com CBERS-4A"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=geoai-alta-resolucao-cbers-4a"
