...
export default function PotencialUsoConservacionistaPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl mx-auto">
                Planejamento de Uso Conservacionista do Solo
              </h1>
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Gere mapas de capacidade de uso da terra em minutos e aplique critérios técnicos automatizados para adequação ambiental e agrícola, com padrão profissional para planejamento e tomada de decisão.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {[
                    "Classificar a capacidade de uso do solo com critérios conservacionistas",
                    "Integrar solo e relevo para recomendação de uso",
                    "Gerar mapas técnicos prontos para planejamento ambiental e agrícola",
                    "Padronizar resultados para relatórios e projetos",
                    "Aplicar a metodologia com segurança em trabalhos acadêmicos, consultorias e perícias",
                  ].map((item, idx) => (
              ...
              <section id="requisitos">
                ...
                <ul className="space-y-3">
                  {[
                    "Estudantes e pesquisadores em Geografia, Agronomia e Ciências Ambientais",
                    "Analistas ambientais e de geoprocessamento",
                    "Consultores e profissionais de planejamento territorial",
                    "Profissionais que atuam com adequação ambiental e uso do solo",
                    "Quem precisa de resultados técnicos rápidos, objetivos e reproduzíveis",
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group">
              ...
              <section id="temario">
                ...
                <div className="space-y-2">
                  {[
                    {
                      title: "Módulo 1 – Fundamentos do Uso Conservacionista",
                      content: "Capacidade de uso da terra, limitações e critérios técnicos aplicados ao planejamento.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: true,
                    },
                    {
                      title: "Módulo 2 – Dados de Entrada: Solo e Relevo",
                      content: "Preparação e padronização dos insumos para classificação sem erros.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 3 – O Motor de Decisão",
                      content: "Implementação dos critérios e regras de decisão para definir as classes de capacidade de uso.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 4 – Zoneamento e Mapas Finais",
                      content: "Geração automática dos mapas, validação e exportação para uso técnico.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
                    {
                      title: "Módulo 5 – Relatórios Técnicos e Aplicações Reais",
                      content: "Padrões de saída, mapas para tomada de decisão e aplicação em projetos e perícias.",
                      aulas: 0,
                      duracao: "00h 00m",
                      open: false,
                    },
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("potencial-uso-conservacionista", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300 transition-shadow">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/potencial-uso-conservacionista.png"
                        alt="Planejamento de Uso Conservacionista do Solo"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=potencial-uso-conservacionista"
