...
export default function GeotecnologiasComoMetodoCientificoPage() {
  return (
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("geotecnologias-como-metodo-cientifico", COURSES).map((testimonial, idx) => (
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=geotecnologias-como-metodo-cientifico"
