...
export default function MonitoramentoRemotoQualidadeAguaPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
                Estime parâmetros de qualidade da água por sensoriamento remoto e gere mapas e séries temporais de turbidez, clorofila e material em suspensão com rotinas automatizadas.
              </p>
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              <section id="aprendera">
                ...
                <ul className="space-y-3">
                  {["Acesso à Ferramenta Water Quality Remote Analyzer","Estimativa de turbidez e material em suspensão","Modelagem de clorofila e indicadores bio-ópticos","Mapas e séries temporais prontos para gestão hídrica"].map((item, idx) => (
              ...
              <section id="depoimentos">
                ...
                <div className="space-y-6">
                  {getTestimonialsBySlug("monitoramento-remoto-qualidade-agua", COURSES).map((testimonial, idx) => (
              ...
              <div className="sticky top-24 bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="relative w-full h-56 bg-gradient-to-br from-slate-800 to-slate-900">
                  <HideOnError>
                    {({ hidden, onError }) => (
                      <Image
                        src="/courses/monitoramento-remoto-qualidade-agua.png"
                        alt="Monitoramento Remoto da Qualidade da Água"
                        fill
                        className={`object-cover ${hidden ? 'hidden' : ''}`}
                        onError={onError}
                      />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <Link
                    href="/lista-interesse?curso=monitoramento-remoto-qualidade-agua"
