...
export default function PericiaAmbientalPage() {
  const service = periciaServices['pericia-ambiental'];
    ...
    <div className="min-h-screen bg-[#02040a] relative" data-variant="studio">
      ...
      <main className="relative z-10 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <SectionHeader
            title="O que é"
            subtitle="Entenda o serviço de assistência técnica pericial e perícia ambiental"
          />
          ...
          <SectionHeader
            ...
            subtitle="Análises críticas, mapas de suporte e laudos técnicos"
          />
          <Card className="p-6 mb-16" glass>
          ...
          <SectionHeader
            title="Pacotes"
            subtitle="Escolha o nível de assistência adequado ao seu caso"
          />
